...
const Services = () => {
  return (
    <div className="bg-gray-100 py-24 sm:py-32">
      ...
      {/* <div className="bg-white py-12 px-12    mx-auto mt-12 grid grid-cols-1 md:grid-cols-2 justify-items-center">
        <div className="ring-2 md:w-96 ring-gray-300 rounded-3xl p-8">
        ...
        <div className="ring-2 md:w-96 ring-indigo-200 rounded-3xl p-8">
          <h3 className="text-indigo-300 text-lg font-semibold leading-8">
            Individual In-car Lessons
          </h3>
          <p className="mt-4 text-sm leading-6 text-gray-600">
      ...
      <div className="bg-white py-12 px-9 lg:px-12 mx-auto mt-12 flex flex-wrap items-center justify-center">
        ...
        <div className="ring-2 w-full lg:h-[500px] md:w-[42%] lg:w-1/3 ring-indigo-200 rounded-3xl p-8 mr-2 ml-2">
          <h3 className="text-indigo-400 text-sm font-bold leading-0">
